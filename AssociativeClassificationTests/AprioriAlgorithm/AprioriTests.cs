...
namespace AssociativeClassificationTests.AprioriAlgorithm
{
    ...
    public class AprioriTests
    {
        ...
        public AprioriTests()
        {
            ...
            _transactions = new string[4] { "a;c;d", "b;c;e", "a;b;c;e", "b;e" };
            _target = new Apriori();
        }
        ...
        public void ProcessTransactionTest()
        {
            ...
            Assert.AreEqual(2, actual.FrequentItems["a;c"].Support);
            Assert.AreEqual(2, actual.FrequentItems["b;c"].Support);
            Assert.AreEqual(3, actual.FrequentItems["b;e"].Support);
            Assert.AreEqual(2, actual.FrequentItems["c;e"].Support);
            Assert.AreEqual(2, actual.FrequentItems["b;c;e"].Support);

            Assert.AreEqual(2, actual.MaximalItemSets.Count);
            Assert.AreEqual("a;c", actual.MaximalItemSets[0]);
            Assert.AreEqual("b;c;e", actual.MaximalItemSets[1]);

            Assert.AreEqual(5, actual.StrongRules.Count);
        }

        #region Tests for private methods
        //[TestMethod()]
